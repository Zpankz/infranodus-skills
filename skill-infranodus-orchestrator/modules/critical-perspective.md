...
> **Layer**: 3 | **Dependencies**: `core/types.md`, `modules/content-analysis`, `modules/research-engine`, `modules/comparative-analysis`
...
## Port Connections
- **Depends on**: `← core/types.md` `← modules/content-analysis` `← modules/research-engine` `← modules/comparative-analysis`
