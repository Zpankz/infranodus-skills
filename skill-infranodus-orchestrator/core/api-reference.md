...
- **Consumed by**: `→ modules/graph-generation.md` `→ modules/content-analysis.md` `→ modules/research-engine.md` `→ modules/comparative-analysis.md` `→ modules/seo-tools.md` `→ modules/memory-manager.md` `→ modules/search-discovery.md`
