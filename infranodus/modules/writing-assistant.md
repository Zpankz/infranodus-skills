...
> **Layer**: 3 | **Dependencies**: `core/types.md`, `core/text-processing.md`, `core/api-reference.md`
...
## Port Connections
- **Depends on**: `← core/types.md` `← core/text-processing.md` `← core/api-reference.md`
