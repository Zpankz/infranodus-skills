...
> **Layer**: 1 | **Dependencies**: `core/types.md` | **Dependents**: `core/api-reference`, `modules/cognitive-variability`, `bridges/state-transition-engine`
...
- **Consumed by**: `→ core/api-reference.md` `→ modules/cognitive-variability.md` `→ bridges/state-transition-engine.md`
